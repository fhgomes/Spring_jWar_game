...
public class ClassicGameValidator {
	...
	public void validatePlayers(List<ClassicGamePlayer> players) {
	...
	public void validateCountryOwner(int srcPlayer, ClassicGameCountry classicGameCountry) {
	...
	public void validateOwnerAvailability(ClassicGamePlayer player, int qtdTroops) {
	...
	public void validateMyTurn(int srcPlayer, int currentPlayer) {
		if (srcPlayer != currentPlayer) {
			throw new GameRulesException("Não é possível executar esta ação fora do seu turno");
		}
	}

	public void validateCountryTarget(ClassicGameCountry src, ClassicGameCountry target) {
